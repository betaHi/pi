...
![append 一条消息：新节点 parentId 指向当前 leaf，写入后 leaf 前移](./pi_07_2.png)
...
![两种遍历：沿 parentId 回溯一条链 vs 向下铺整棵树](./pi_07_3.png)
...
![分支：leaf 移回 C，append E 后 C 同时有 D、E 两个子节点](./pi_07_4.png)
...
![压缩触发与切点：reserveTokens 决定何时触发，keepRecentTokens 决定保留多少近处原文](./pi_07_5.png)
...
![压缩投影成三段：摘要 + 保留原文 + 压缩点之后的新消息](./pi_07_6.png)
...
![读回重建：JSONL 平铺文件经 parse 建出 byId 与 leaf，子节点关系运行时按 parentId 现算](./pi_07_7.png)
...
![/tree 与 /fork：同一棵树移动 leaf vs 复制成新树](./pi_07_8.png)
